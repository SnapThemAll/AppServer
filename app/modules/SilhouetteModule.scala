...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  def configure() {
    ...
    bind[AuthenticatorRepository[BearerTokenAuthenticator]].to[CacheAuthenticatorRepository[BearerTokenAuthenticator]]
    val clazz = classOf[BearerTokenAuthenticator]
    bind[ClassTag[BearerTokenAuthenticator]].toInstance(ClassTag(clazz))
  ...
  /**
    ...
    * @return The the social provider registry.
    */
  @Provides
  def provideSocialProviderRegistry(fakeProvider: FakeSocialProvider,
  ...
  def provideOAuth1TokenSecretCookieSigner(configuration: Configuration): CookieSigner = {
    val config =
      configuration.underlying.as[JcaCookieSignerSettings]("silhouette.oauth1TokenSecretProvider.cookie.signer")
  ...
  /**
    ...
    */
  @Provides
  def provideCookieAuthenticatorService(@Named("authenticator-cookie-signer") cookieSigner: CookieSigner,
  ...
  /**
    ...
    */
  @Provides
  def provideBearerAuthenticatorService(repository: AuthenticatorRepository[BearerTokenAuthenticator],
                                        fingerprintGenerator: FingerprintGenerator,
                                        idGenerator: IDGenerator,
                                        configuration: Configuration,
                                        clock: Clock): AuthenticatorService[BearerTokenAuthenticator] = {

    new BearerTokenAuthenticatorService(BearerTokenAuthenticatorSettings(), repository, idGenerator, clock)
  }
  ...
  /**
    ...
    */
  @Provides
  def provideOAuth1TokenSecretProvider(@Named("oauth1-token-secret-cookie-signer") cookieSigner: CookieSigner,
  ...
  /**
    ...
    */
  @Provides
  def provideFakeProvider(httpLayer: HTTPLayer,
                          stateProvider: OAuth2StateProvider,
                          configuration: Configuration): FakeSocialProvider = {

    new FakeSocialProvider(httpLayer,
                           stateProvider,
